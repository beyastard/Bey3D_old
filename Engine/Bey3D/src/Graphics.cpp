...
{
	return "Bey3D Graphics Exception";
}
...
{
	return "Bey3D Graphics Info Exception";
}
...
Graphics::Graphics(HWND hWnd)
{
	...
	HRESULT hr; // for checking results of D3D11 functions
...
void Graphics::DrawTestTriangle()
{
	...
	// create vertex buffer (a single 2D triangle)
